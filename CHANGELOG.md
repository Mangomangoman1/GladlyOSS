...
All notable changes to Gladly will be documented in this file.
...
- Weighted audit engine for nine open-source readiness signals.
- Public GitHub repository lookup without an account or token.
- Prioritized findings with plain-language guidance.
- Projected score impact for checklist items, selected templates, and reports.
